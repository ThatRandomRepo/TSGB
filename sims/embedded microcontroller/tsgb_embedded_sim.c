...
const float gear_ratios[12] = {2.20122, 2.18188, 2.16267, 2.14389, 2.12523, 2.10678, 2.08855 , 2.07053, 2.05267, 2.03496, 2.01740, 2.0};
const float torque_offsets[12] = {420, 401.8, 383.6, 365.4, 347.2, 329.0, 310.9, 292.7, 274.5, 256.3, 238.1, 220};
